const Headline = () => {
  return (
    <div className="flex flex-col items-center gap-4 px-4 md:px-10">
      <h1 className="text-center align-middle font-recoleta font-normal text-[28px] text-nowrap md:text-[64px] lg:text-[80px] xl:text-[98px] fade-in-zoom mt-4 ">
        Design.{" "}
      ...
      <div className="flex flex-row gap-4 justify-center items-center md:w-92">
